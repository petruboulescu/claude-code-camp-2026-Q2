...
def run(
    *,
    ...
    configured_iterations = getattr(cfg, "agent_max_iterations", PLAYER.max_iterations(task_settings))
    configured_output_tokens = getattr(cfg, "agent_max_output_tokens", PLAYER.max_output_tokens(task_settings))
    configured_turn_tokens = getattr(cfg, "agent_max_turn_tokens", 60_000)
    configured_compaction = getattr(cfg, "agent_compaction_threshold", 0.85)
    ...
    context_window = Models.context_window(model) if context_window is None else context_window

    context = Context(
        task=PLAYER,
        system=system,
        context_window=context_window,
        compaction_threshold=configured_compaction,
    ...
    try:
        ...
        effective_max_iterations = configured_iterations
        ...
        logger = Logger(
            ...
            snapshot={
                ...
                "max_turn_tokens": configured_turn_tokens,
